...
abstract class $TokenCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, String token, String tokenTime});
}
...
class _$_Token implements _Token {
  const _$_Token({this.message = '', this.token = '', this.tokenTime = ''});
  ...
  @override
  String toString() {
    return 'Token(message: $message, token: $token, tokenTime: $tokenTime)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, message, token, tokenTime);
...
abstract class _Token implements Token {
  const factory _Token(
      {final String message,
      final String token,
      final String tokenTime}) = _$_Token;
